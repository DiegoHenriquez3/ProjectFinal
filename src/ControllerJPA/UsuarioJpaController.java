...
public class UsuarioJpaController implements Serializable {
    ...
    public void create(Usuario usuario) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            em.persist(usuario);
            if (idEmpleado != null) {
                idEmpleado.getUsuarioList().add(usuario);
    ...
    public void edit(Usuario usuario) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getUsuarioList().remove(usuario);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getUsuarioList().add(usuario);
            ...
            if (msg == null || msg.length() == 0) {
                BigDecimal id = usuario.getIdUser();
    ...
    public void destroy(BigDecimal id) throws NonexistentEntityException {
        ...
        try {
            ...
            Empleado idEmpleado = usuario.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getUsuarioList().remove(usuario);
                idEmpleado = em.merge(idEmpleado);
            }
            em.remove(usuario);
            em.getTransaction().commit();
